 ...
 * Ahora utiliza la función universal enviar_email para consistencia de diseño
 */
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'request_otp') {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if (mysqli_query($connection, $update)) {
                $subject = "Código de Seguridad - SINCRM3";
                $html = "
    ...
    if ($action == 'reset_password') {
        ...
        if (mysqli_query($connection, $update)) {
            ...
            $subject_confirm = "Contraseña Actualizada Correctamente - SINCRM3";
            $html_confirm = "
            <h2 style='color: #10b981;'>¡Contraseña Cambiada!</h2>
            <p>Hola,</p>
            <p>Te informamos que la contraseña de tu cuenta en <strong>SINCRM3</strong> ha sido actualizada correctamente.</p>
            <div class='alert-box alert-info'>
                Si no has realizado este cambio, por favor ponte en contacto con nosotros inmediatamente.
            </div>
            <div style='text-align: center; margin-top: 30px;'>
                <a href='https://sincrm.pedrodiaz.eu/login.php' class='btn'>Acceder a mi Cuenta</a>
            </div>";
            ...
            echo json_encode(['status' => 'error', 'message' => 'Error al actualizar la contraseña en el sistema.']);
        }
        exit;
    }
}
