        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <?php
              $query = "SELECT clubes.id, clubes.nombre, clubes.nombre_corto, clubes.codigo, clubes.logo, federaciones.nombre_corto AS federacion_nombre_corto FROM clubes, federaciones WHERE federacion = federaciones.id"; 
