...
if(isset($_POST['save_btn'])){
    ...
    write_log("Inscripción de figuras realizada para nadadora #$id_nadadora en competición #$id_competicion", "SUCCESS");
...
if(isset($_POST['update_orden_btn'])){
    ...
    if($res_info && $info = mysqli_fetch_assoc($res_info)){
        ...
        if(mysqli_query($connection, $q_upd)){
            write_log("Orden manual actualizado a $nuevo_orden para nadadora #$nadadora (Figuras, Competición #$comp)", "INFO");
...
if(isset($_POST['delete_btn'])){
    ...
    if($res_info && $info = mysqli_fetch_assoc($res_info)){
        ...
        if(mysqli_query($connection, $q_del)){
            write_log("Inscripción completa eliminada para nadadora #$nadadora en competición #$comp", "WARNING");
