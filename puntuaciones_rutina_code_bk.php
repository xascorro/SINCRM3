...
//        $compensacion = $errores_sincro-$nota_elementos;
    ...
    $query ="UPDATE rutinas SET nota_final = (SELECT sum(nota) - $penalizaciones FROM puntuaciones_elementos WHERE id_rutina=$id_rutina)-(SELECT nota from errores_sincronizacion WHERE id_rutina=$id_rutina) WHERE id=$id_rutina ";
    mysqli_query($connection,$query);
