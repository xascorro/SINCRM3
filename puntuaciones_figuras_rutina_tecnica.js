...
//vuelto input a aspecto original cuando pierde el foco y bajo a escala 0-10
$('input[type="number"]').blur(function() {
    ...
    if (!Number.isInteger(this.value/0.25)){
        $(this).css({'background-color':'#FFCDBA', 'color':'black'});
        this.value = Math.round( this.value/0.25 , 0) * 0.25;

    }
});
//si es el elemento 5 y esta vacio saco la media
//$('#notaE1J5').blur(function() {
//    if(this.value == '0'){
//        $valor = 0;
//        $valor = (+document.getElementById("notaE1J1").value) + (+document.getElementById("notaE1J2").value) + (+document.getElementById("notaE1J3").value) + (+document.getElementById("notaE1J4").value);
//        $valor = $valor/4;
//        $vlor = value = Math.round( this.value/0.1 , 0) * 0.1;
//        this.value = $valor;
//    }
//});
//$('#notaE2J5').blur(function() {
//    if(this.value = ''){
//        $valor = 0;
//        $valor = (+document.getElementById("notaE2J1").value) + (+document.getElementById("notaE2J2").value) + (+document.getElementById("notaE2J3").value) + (+document.getElementById("notaE2J4").value);
//        this.value = $valor/4;
//    }
//});
//$('#notaE3J5').blur(function() {
//    if(this.value = ''){
//        $valor = 0;
//        $valor = (+document.getElementById("notaE3J1").value) + (+document.getElementById("notaE3J2").value) + (+document.getElementById("notaE3J3").value) + (+document.getElementById("notaE3J4").value);
//        this.value = $valor/4;
//    }
//});
//$('#notaE4J5').blur(function() {
//    if(this.value = ''){
//        $valor = 0;
//        $valor = (+document.getElementById("notaE4J1").value) + (+document.getElementById("notaE4J2").value) + (+document.getElementById("notaE4J3").value) + (+document.getElementById("notaE4J4").value);
//        this.value = $valor/4;
//    }
//});
//$('#notaE5J5').blur(function() {
//    if(this.value = ''){
//        $valor = 0;
//        $valor = (+document.getElementById("notaE5J1").value) + (+document.getElementById("notaE5J2").value) + (+document.getElementById("notaE5J3").value) + (+document.getElementById("notaE5J4").value);
//        this.value = $valor/4;
//    }
//});
//
...
//	var id_figura =  $(this).parent().parent().attr('id_figura');
//	var nota = 0.0;
//	var id_nota_media = "";
