...
// -----------------------------------------------------------------------------
//saco fases_figuras
$query = "select id_categoria, id_modalidad, id, orden, elementos_coach_card from fases where id_competicion ='".$GLOBALS["id_competicion_activa"]."' order by orden limit 12,4";
