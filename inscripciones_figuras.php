...
// Suponiendo que $fecha_fin_inscripcion es una cadena en formato 'Y-m-d'
$fecha_fin_inscripcion_obj = new DateTime($fecha_fin_inscripcion);

// Comparación de fechas utilizando objetos DateTime
//if ($fecha_fin_inscripcion_obj >= new DateTime() && $_SESSION['id_rol'] != 1) {
...
//}
		...
		$niveles = $fechas['niveles'];
//echo date('Y-m-d') .'  '. $fecha_fin_inscripcion;
?>
<!-- Content Wrapper -->
<div id="content-wrapper" class="d-flex flex-column">
    ...
    ?>
		...
		<div class="container-fluid" style="padding:0px 0px 0px 5px">
			...
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h4 class="mb-0 font-weight-bold text-primary"><i class="fa-regular fa-flag"></i>
					<?php
					if($niveles == 'si')
						echo 'Inscripciones Pase de Nivel';
					else
						echo 'Inscripciones en Figuras';
					?>
	...
	?>
					...
					?>
					<a target="_blank" href="./informes/informe_figuras_preinscripciones.php?id_competicion=<?php echo $id_competicion?>&club=<?php echo $_SESSION['club']?>&titulo=Inscripciones <?php echo $_SESSION['nombre_club']?>" class="btn btn-primary shadow"><i class="fas fa-download fa-sm text-white-50"></i> PDF</a>
					<?php
          ...
          ?>
				...
				<?php
            $query = "SELECT DISTINCT fases.id_categoria, categorias.nombre, categorias.edad_minima, categorias.edad_maxima FROM fases, categorias WHERE fases.id_categoria = categorias.id and fases.id_competicion = ".$id_competicion;
