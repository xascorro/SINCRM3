      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="card-body">
          ...
          <div class="table-responsive">
            <?php
                $query = "SELECT clubes.nombre_corto as nombre_club, inscripciones_figuras.id, inscripciones_figuras.orden as orden, inscripciones_figuras.id_nadadora, nadadoras.nombre as nombre_nadadora, nadadoras.apellidos as apellidos_nadadora, categorias.nombre as nombre_categoria, inscripciones_figuras.id_fase, fases.elementos_coach_card FROM inscripciones_figuras, fases, modalidades, categorias, nadadoras, clubes WHERE nadadoras.club = clubes.id and fases.id = ".$_POST['id_fase'] ." and inscripciones_figuras.id_fase = fases.id and fases.id_modalidad = modalidades.id and fases.id_categoria = categorias.id and inscripciones_figuras.id_nadadora = nadadoras.id and fases.id_competicion = ".$_SESSION['id_competicion_activa']." ORDER BY inscripciones_figuras.orden, inscripciones_figuras.id, fases.orden, fases.id";
                    ...
                    <i class="fas fa-file"></i>
                      ...
                      <td>
                        <form  target="_blank" action="puntuaciones_figuras_rutina_tecnica.php" method="post">
                          ...
                          <input type="hidden" name="apellidos_nadadora" value="<?php echo $row['apellidos_nadadora']; ?>">
                          <button class="btn btn-success" type="submit" name="edit_btn"><i class="fa-solid fa-square-root-variable"></i></btn>
                          </form>
                        </td>
                        </tr>
                        <tr>
