        ...
        <div class="flex flex-col items-center gap-6">
            ...
            <div class="flex flex-col items-center gap-2">
                ...
                <p class="text-[10px] font-black uppercase tracking-[0.3em] text-slate-300">
                    © <?php echo date('Y'); ?> FNRM · SINCRM 3.0
                </p>
            </div>

            <!-- Branding sutil -->
            <div class="pt-4 opacity-20 hover:opacity-100 transition-opacity duration-700">
                <img src="img/logo_sincrm3.png" class="h-6 grayscale" alt="v3">
            </div>
